  ...
  return (
    ...
    >
      <div className="space-y-6">
        <div className="mb-8">
          <MediaSection
            imageSrc="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1920&q=80"
            altText="Beautiful home exterior representing home loan calculations"
            position="right"
          />
        </div>
        ...
        <div className="mt-8">
          <MediaSection
            ...
            altText="Home loan documents and calculator"
            position="left"
          />
        </div>
      </div>
